...
//		$("#con_list").html('<img src="images/load.gif" class="load" alt="加载中..." />');
...
//	});
	...
	/*$("#webnotelist").live("click", function() {
		...
		$("#webNote").html('<img src="images/load.gif" class="load" alt="加载中..." />');
		webnotelist();
	});
	//绑定媒体报道点击事件
	...
	$('#rank').live("click", function() {
		...
		$("#investRank").html('<img src="images/load.gif" class="load" alt="加载中..." />');
		investRank();
	});
	//绑定月排名点击事件
