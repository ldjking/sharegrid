...
<div class='top'>
	<span class='top_con'>
		...
		<!-- 登陆后 -->
		<!-- 首页 -->
			<a class='index_top_btn top_btn' href='#'>余额：&nbsp;0.0元</a>
			<!-- 我的账户 -->
			<a class='account_top_btn top_btn' href='http://www.xiaoniu88.com/weChat/wx_logout.do'>安全退出</a>
			<!-- 其他页面 -->
  			...
  			<div class='index_container'>
  				...
  				<div class='anxinniu_detail'>
  					<div class='anxinniu_rate'>
  						...
  						<span class='rate_num'>13.80 - 14.20%</span>
  						<span class='amount'>计划金额：1,000,000 元 </span>
  					</div>
  					<div class='anxinniu_time'>
  						<span class='detail_title'>期限 </span>
  						<span class='detail_time'><span class='time_num' style='display:inline-block;'>6</span><span style='display:inline-block;vertical-align:bottom'>个月</span></span>
  						<span class='amount'>起投金额：1,000元</span>
  					</div>
  				</div>
  				<span class='join_end'>您来晚啦，已满额！</span>
  				<span class='join_num'>已有15人加入</span>
  			</div>
  		</div>
  	</div>
