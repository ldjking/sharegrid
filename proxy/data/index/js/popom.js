...
Popup.prototype=
{
	...
	},build:function ()
	{
		...
		var close='<input type="image" id="dialogBoxClose" src="../../js/common/dialog/dialogclose.gif" border="0" width="28" height="15" align="absmiddle" title="关闭"/>';
	...
	},lastBuild:function ()
	{
		...
		{
			var openIframe="<iframe width='100%' style='height:"+this.config.height+"px' name='"+this.iframeIdName+"' id='"+this.iframeIdName+"' src='../../js/"+this.info.contentUrl+"' frameborder='0' scrolling='"+this.config.scrollType+"'></iframe>";
