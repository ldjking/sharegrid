...
function kf_getPopupDivHtml(kfguin,reference,companyname,welcomeword, wpadomain)
{
	var temp = '';
  	...
  	temp += '<img src="../../step2/script/'+urlroot+'web/pic_zixun0704_nv.jpg" class="zixun0704_img" />';
  	temp += '<p class="zixun0704_font">'+welcomeword+'</p>';
  	temp += '<div class="zixun0704_button"><a href="javascript:void(0);" onclick="kf_openChatWindow(1,\'b\',\''+kfguin+'\')"><img src="../../step2/script/'+urlroot+'web/pic_zixun0704QQ.jpg" /></a> <a href="javascript:void(0);" onclick="kf_hidekfpopup();return false;"><img src="../../step2/script/'+urlroot+'web/pic_zixun0704_later.jpg" /></a></div>';
