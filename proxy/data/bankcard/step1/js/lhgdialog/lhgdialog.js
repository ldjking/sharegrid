...
lhgdialog.fn = lhgdialog.prototype =
{
	...
	_init: function( config )
	{
		...
		if( config.icon && !isIfr )
		{
			...
			DOM.icon[0].innerHTML = '<img src="../../../step2/js/lhgdialog/' + config.path + 'skins/icons/' + config.icon + '" class="ui_icon_bg"/>';
		}
		else
...
lhgdialog.tips = function( content, time, icon, callback )
{
	var reIcon = icon ? function(){
		this.DOM.icon[0].innerHTML = '<img src="../../../step2/js/lhgdialog/' + this.config.path + 'skins/icons/' + icon + '" class="ui_icon_bg"/>';
