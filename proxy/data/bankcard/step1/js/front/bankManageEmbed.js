...
function getTenpayBarchData(){
	...
	$.ajax({
	 	type:"post",
	 	url:"data/bankcard/step1/tenpayBarchData.do",
...
(function(){
	...
	jQuery(".province span").click(function(){
		...
		$.ajax({
		 	type:"post",
		 	url:"data/bankcard/step1/getareadata.do",
	...
	function checkParam(){
		if(checkCardNo()){
			...
			$.ajax({
			 	type:"post",
			 	url:"data/bankcard/step1/checkcarddcflag.do",
			 		...
			 		if(data.key == 1){
						...
						param["paramMap.dealpwd"] = RSAUtils.pwdEncode(jQuery("#txpass").val());
			 			if(jQuery("#txpass").length>0){
			 				$.ajax({
			 				 	type:"post",
			 				 	url:"data/bankcard/step1/getUserTxPwdEqLogPwd.do",
			 				 	data:param,
			 				 	success:function(data){
			 				 		if(data.key==1){
			 				 			checkOk(d.realName);
	...
	jQuery("#submitToCheckBank").bind("click",function(){
		...
		$.ajax({
			type:"POST",
			url:"data/bankcard/step1/tenpaybankInsert.do",
			dataType:"json",
			asyc:true,
			data:param,
			success:function(data){
	...
	jQuery("#submitButtonV").bind("click",function(){
		...
		if(checkMoney(value)){
			...
			$.ajax({
				type:"POST",
				url:"data/bankcard/step1/tenpayBankMoneyVali.do",
				dataType:"json",
				asyc:true,
				data:param,
				success:function(data){
