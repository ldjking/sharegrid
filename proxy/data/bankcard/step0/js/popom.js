...
Popup.prototype=
{
	iframeIdName:'ifr_popup',initialize:function (config)
	{
		...
		this.color=
		{
			cColor:"#EEEEEE",bColor:"#FFFFFF",tColor:"#ab6f00",wColor:"#FFFFFF"
		};
		this.dropClass=null;
		this.someToHidden=[];
	...
	},build:function ()
	{
		...
		var close='<input type="image" id="dialogBoxClose" src="../../step1/js/common/dialog/dialogclose.gif" border="0" width="28" height="15" align="absmiddle" title="关闭"/>';
	...
	},lastBuild:function ()
	{
		...
		{
			var openIframe="<iframe width='100%' style='height:"+this.config.height+"px' name='"+this.iframeIdName+"' id='"+this.iframeIdName+"' src='../../step1/js/"+this.info.contentUrl+"' frameborder='0' scrolling='"+this.config.scrollType+"'></iframe>";
