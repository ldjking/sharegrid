...
lhgdialog.fn = lhgdialog.prototype =
{
	...
	_init: function( config )
	{
		...
		if( config.icon && !isIfr )
		{
			...
			DOM.icon[0].innerHTML = '<img src="../../../step1/js/lhgdialog/' + config.path + 'skins/icons/' + config.icon + '" class="ui_icon_bg"/>';
		}
		else
 ...
 */
lhgdialog.confirm = function( content, okVal, yes, no, parent )
{
	return lhgdialog({
		title: '温馨提醒',
		id: 'confirm.gif',
 ...
 * @param	{String}	消息内容
 */
lhgdialog.errorTips = function( content, callback, parent )
{
	return lhgdialog({
		title: '温馨提醒',
		id: 'errorTips',
 ...
 * @param	{String}	消息内容
 */
lhgdialog.successTips = function( content, callback, parent )
{
	return lhgdialog({
		title: '温馨提醒',
		id: 'successTips',
 ...
 * @param	{String}	消息内容
 */
lhgdialog.warnTips = function( content, callback, parent )
{
	return lhgdialog({
		title: '温馨提醒',
		id: 'successTips',
 ...
 * @param	{String}	消息内容
 */
lhgdialog.commonTips = function( content, callback, parent )
{
	return lhgdialog({
		title: '温馨提醒',
		id: 'commonTips',
...
lhgdialog.tips = function( content, time, icon, callback )
{
	var reIcon = icon ? function(){
		this.DOM.icon[0].innerHTML = '<img src="../../../step1/js/lhgdialog/' + this.config.path + 'skins/icons/' + icon + '" class="ui_icon_bg"/>';
